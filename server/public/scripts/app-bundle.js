                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.next = 4;
                                return this.data.uploadFiles(formData, this.TODO_SERVICE + "/uploads/" + userId + "/" + todoId);
